...
- ### Changed
  ...
  - **Instrument Abstraction**
    ...
    - Fixed an issue where `TSMSessionManager` was unable to return a `DigitalSessionsBundle` object for a shared resource pin when one or more enabled sites were deactivated from the handler. The `TSMSessionManager` now correctly identifies handler-deactivated sites and returns the appropriate `DigitalSessionsBundle` object.
  - **Documentation**
