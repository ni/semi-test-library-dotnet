...
- ### Added
  ...
  - **Instrument Abstraction**
    ...
    - New `ForceAdvancedSequenceSynchronized` DCPower methods added for synchronizing and forcing an advanced sequence of `DCPowerSourceSettings` across all sessions in the bundle. The methods support scalar, per-site, and per-site-per-pin sequence data. Refer to the updated documentation for details.
