...
namespace NationalInstruments.SemiconductorTestLibrary.TestStandSteps
{
    ...
    public static partial class SetupAndCleanupSteps
    {
        ...
        public static void CleanupAllInstrumentation(
        ...
        /// <summary>
        /// [Deprecated] This method is deprecated, use 'CleanupAllInstrumentation' instead.Supported in 24.5.x.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="resetDevice">Whether to reset device during initialization.</param>
        /// <param name="instrumentType">The type of instrument to close.</param>
        [Obsolete("Use 'CleanupAllInstrumentation' instead.")]
        ...
        {
            CleanupAllInstrumentation(tsmContext, resetDevice, (TestStandSteps.NIInstrumentType)instrumentType);
        }

        /// <summary>
        /// [Deprecated] This method is deprecated, use 'CleanupAllInstrumentation' instead. Supported in 25.0 and 25.5.
        /// </summary>
        /// <remarks>
        /// This method makes a callback to new overload  method.Supported in 24.5.x
        /// </remarks>
        /// <param name="tsmContext">The <see cref="ISemiconductorModuleContext"/> object.</param>
        /// <param name="resetDevice">Whether to reset device during initialization.</param>
        /// <param name="instrumentType">The type of instrument to close.</param>
        ...
        public static void CleanupInstrumentation(
            ...
            TestStandSteps.NIInstrumentType instrumentType = TestStandSteps.NIInstrumentType.All)
        {
            CleanupAllInstrumentation(tsmContext, resetDevice, instrumentType);
        }
