...
namespace NationalInstruments.Examples.SemiconductorTestLibrary.RegisterIO.SPI
{
    ...
    /// </para>
    /// </remarks>
    public class RegisterIO_SPI : IDigitalProtocol
    {
        ...
        /// <summary>
        /// Constructs a <see cref="RegisterIO_SPI"/> object to read and write to DUT registers via SPI.
        /// </summary>
