...
namespace NationalInstruments.SemiconductorTestLibrary.Examples.CustomerInstrument.MyCustomInstrument
{
    ...
    /// </summary>
    /// <remarks>
    /// User has to create separate concrete implementations for different Custom Instrument types.
    /// </remarks>
    public class MyCustomInstrument : ICustomInstrument
    {
        ...
        /// If the Driver Session is not a class object, for example, String type or Integer type, just define them with default data.
        /// </remarks>
