...
{
    /// <summary>
    /// Set of examples to demonstrate using the <see cref="RegisterIO_I2C"/> class
    /// through the <see cref="IDigitalProtocol"/> interface.
    /// </summary>
    public static class TestStepUsingI2C
    {
        /// <summary>
        /// Writes a broadcast value to a single register via I2C and reads it back for comparison.
        /// </summary>
        ...
        /// <summary>
        /// Writes site-unique values to a single register via I2C and reads it back for comparison.
        /// </summary>
        ...
        /// <summary>
        /// Writes unique values to multiple registers via I2C and reads them all back for comparison.
        /// </summary>
