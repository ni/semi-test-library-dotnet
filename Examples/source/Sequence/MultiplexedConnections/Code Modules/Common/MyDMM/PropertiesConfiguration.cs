...
namespace SemiconductorTestLibrary.Examples.MultiplexedConnections.Common.MyDMM
{
    ...
    public static class PropertiesConfiguration
    {
        ...
        public static void ConfigureACBandwidth(this MyDMMSessionsBundle sessionsBundle, double minimumFrequency = 20, double maximumFrequency = 25000)
        {
        ...
        public static void ConfigureApertureTime(this MyDMMSessionsBundle sessionsBundle, DmmApertureTimeUnits apertureTimeUnits = DmmApertureTimeUnits.Seconds, double apertureTime = 0)
        {
            sessionsBundle.Do(sessionInfo =>
            {
        ...
        public static void ConfigureSettleTime(this MyDMMSessionsBundle sessionsBundle, double settleTime = 0.01)
        {
            sessionsBundle.Do(sessionInfo =>
            {
        ...
        public static void ConfigureMeasurementAbsolute(this MyDMMSessionsBundle sessionsBundle, DmmMeasurementFunction measurementFunction = DmmMeasurementFunction.DCVolts, double range = 0.02, double resolutionAbsolute = 0.001)
        {
            sessionsBundle.Do(sessionInfo =>
            {
        ...
        public static void ConfigureMeasurementDigits(this MyDMMSessionsBundle sessionsBundle, DmmMeasurementFunction measurementFunction = DmmMeasurementFunction.DCVolts, double range = 0.02, double resolutionDigits = 5.5)
        {
            sessionsBundle.Do(sessionInfo =>
            {
        ...
        public static void ConfigureMultiPoint(this MyDMMSessionsBundle sessionsBundle, int triggerCount, int sampleCount, string sampleTrigger, double sampleIntervalInSeconds)
        {
            sessionsBundle.Do(sessionInfo =>
            {
        ...
        public static void ConfigurePowerlineFrequency(this MyDMMSessionsBundle sessionsBundle, double powerlineFrequency = 60)
        {
            sessionsBundle.Do(sessionInfo =>
            {
        ...
        public static void ConfigureTrigger(this MyDMMSessionsBundle sessionsBundle, DmmTriggerSource triggerSource, double triggerDelayInSeconds)
        {
            sessionsBundle.Do(sessionInfo =>
            {
        ...
        /// </summary>
        /// <param name="sessionsBundle">The <see cref="MyDMMSessionsBundle"/> object.</param>
        public static void SendSoftwareTrigger(this MyDMMSessionsBundle sessionsBundle)
        {
            sessionsBundle.Do(sessionInfo =>
            {
        ...
        public static void ConfigureADCCalibration(this MyDMMSessionsBundle sessionsBundle, DmmAdcCalibration dmmAdcCalibrationMode)
        {
            sessionsBundle.Do(sessionInfo =>
            {
        ...
        public static void ConfigureAutoZero(this MyDMMSessionsBundle sessionsBundle, DmmAuto autoZeroMode)
        {
            sessionsBundle.Do(sessionInfo =>
            {
