...
namespace NationalInstruments.Examples.SemiconductorTestLibrary.RegisterIO.SpiAndI2c.DutControl
{
    ...
    {
        private static I2CProtocolParameters _defaultProtocolParameters = new I2CProtocolParameters();
        ...
        /// <summary>
        /// Sets the global I2C protocol parameters used when an instance is created without explicit parameters.
        ...
        public static void SetProtocolParameters(I2CProtocolParameters protocolParameters)
        {
            _defaultProtocolParameters = protocolParameters ?? throw new ArgumentNullException(nameof(protocolParameters));
        }

        /// <summary>
        /// Gets the current global I2C protocol parameters used when an instance is created without explicit parameters.
        /// </summary>
        public static I2CProtocolParameters CurrentProtocolParameters => _defaultProtocolParameters;

        /// <summary>
        /// Gets the pin names used by this I2C instance.
        /// </summary>
        ...
        /// <summary>
        /// Constructs an <see cref="I2C"/> object using protocol parameters and an internally-created digital bundle.
        /// </summary>
        /// <param name="semiconductorModuleContext">The <see cref="ISemiconductorModuleContext"/> object.</param>
        /// <param name="protocolParameters">The protocol parameters for this I2C instance.</param>
        public I2C(ISemiconductorModuleContext semiconductorModuleContext, I2CProtocolParameters protocolParameters = null)
        {
        ...
        /// <summary>
        /// Constructs an <see cref="I2C"/> object using an externally-created digital bundle.
        /// </summary>
        /// <param name="digitalSessionsBundle">The digital sessions bundle to use.</param>
        /// <param name="protocolParameters">The protocol parameters for this I2C instance.</param>
        public I2C(DigitalSessionsBundle digitalSessionsBundle, I2CProtocolParameters protocolParameters = null)
        {
        ...
        private void Initialize(I2CProtocolParameters parameters)
        {
