using System;
using NationalInstruments.Examples.SemiconductorTestLibrary.RegisterIO.SPI;
using Xunit;

namespace NationalInstruments.Examples.SemiconductorTestLibrary.RegisterIO.SPI.Test
{
    public class LongToU32SamplesTests_LsbFirst
    {
        ...
        {
            uint[] result = RegisterIO_SPI.LongToU32Samples(0xAB, valueBitWidth: 8, sampleBitWidth: 8, BitOrder.LsbFirst);
        ...
        {
            uint[] result = RegisterIO_SPI.LongToU32Samples(0x1234, valueBitWidth: 16, sampleBitWidth: 8, BitOrder.LsbFirst);
        ...
        {
            uint[] result = RegisterIO_SPI.LongToU32Samples(0xBEEF, valueBitWidth: 16, sampleBitWidth: 16, BitOrder.LsbFirst);
        ...
        {
            uint[] result = RegisterIO_SPI.LongToU32Samples(0xDEADBEEF, valueBitWidth: 32, sampleBitWidth: 8, BitOrder.LsbFirst);
        ...
        {
            uint[] result = RegisterIO_SPI.LongToU32Samples(0, valueBitWidth: 16, sampleBitWidth: 8, BitOrder.LsbFirst);
        ...
        {
            uint[] result = RegisterIO_SPI.LongToU32Samples(0xFF, valueBitWidth: 8, sampleBitWidth: 8, BitOrder.LsbFirst);
        ...
        {
            uint[] result = RegisterIO_SPI.LongToU32Samples(0x5A, valueBitWidth: 7, sampleBitWidth: 4, BitOrder.LsbFirst);
    ...
    public class LongToU32SamplesTests_MsbFirst
    {
        ...
        public void SingleSample_8BitValue_8BitWidth_ReturnsCorrectSample()
        {
            uint[] result = RegisterIO_SPI.LongToU32Samples(0xAB, valueBitWidth: 8, sampleBitWidth: 8, BitOrder.MsbFirst);
        ...
        {
            uint[] result = RegisterIO_SPI.LongToU32Samples(0x1234, valueBitWidth: 16, sampleBitWidth: 8, BitOrder.MsbFirst);
        ...
        {
            uint[] result = RegisterIO_SPI.LongToU32Samples(0xDEADBEEF, valueBitWidth: 32, sampleBitWidth: 8, BitOrder.MsbFirst);
        ...
        {
            uint[] result = RegisterIO_SPI.LongToU32Samples(0x1234, valueBitWidth: 16, sampleBitWidth: 8);
    ...
    public class U32SamplesToLongTests_LsbFirst
    {
        ...
        {
            long result = RegisterIO_SPI.U32SamplesToLong(new uint[] { 0xAB }, sampleBitWidth: 8, BitOrder.LsbFirst);
        ...
        {
            long result = RegisterIO_SPI.U32SamplesToLong(new uint[] { 0x34, 0x12 }, sampleBitWidth: 8, BitOrder.LsbFirst);
        ...
        {
            long result = RegisterIO_SPI.U32SamplesToLong(
        ...
        {
            long result = RegisterIO_SPI.U32SamplesToLong(new uint[] { 0xBEEF }, sampleBitWidth: 16, BitOrder.LsbFirst);
        ...
        {
            long result = RegisterIO_SPI.U32SamplesToLong(new uint[] { 0, 0 }, sampleBitWidth: 8, BitOrder.LsbFirst);
    ...
    public class U32SamplesToLongTests_MsbFirst
    {
        ...
        {
            long result = RegisterIO_SPI.U32SamplesToLong(new uint[] { 0x12, 0x34 }, sampleBitWidth: 8, BitOrder.MsbFirst);
        ...
        public void DefaultBitOrder_IsMsbFirst()
        {
            long result = RegisterIO_SPI.U32SamplesToLong(new uint[] { 0x12, 0x34 }, sampleBitWidth: 8);
    ...
    public class RoundTripConversionTests
    {
        ...
        {
            uint[] samples = RegisterIO_SPI.LongToU32Samples(value, valueBitWidth, sampleBitWidth, BitOrder.LsbFirst);
            long roundTripped = RegisterIO_SPI.U32SamplesToLong(samples, sampleBitWidth, BitOrder.LsbFirst);
        ...
        {
            uint[] samples = RegisterIO_SPI.LongToU32Samples(value, valueBitWidth, sampleBitWidth, BitOrder.MsbFirst);
            long roundTripped = RegisterIO_SPI.U32SamplesToLong(samples, sampleBitWidth, BitOrder.MsbFirst);
    ...
    public class LongArrayToU32SamplesTests
    {
        ...
        public void LsbFirst_TwoValues_8BitWidth_ReturnsConcatenatedSamples()
        {
            ...
            uint[] result = RegisterIO_SPI.LongArrayToU32Samples(values, valueBitWidth: 8, sampleBitWidth: 8, BitOrder.LsbFirst);
        ...
        public void LsbFirst_TwoValues_16BitWidth_8BitSample_ReturnsFourSamples()
        {
            ...
            uint[] result = RegisterIO_SPI.LongArrayToU32Samples(values, valueBitWidth: 16, sampleBitWidth: 8, BitOrder.LsbFirst);
        ...
        {
            long[] values = new long[] { 0x1234, 0x5678 };
            uint[] result = RegisterIO_SPI.LongArrayToU32Samples(values, valueBitWidth: 16, sampleBitWidth: 8, BitOrder.MsbFirst);
        ...
        {
            long value = 0xDEAD;
            uint[] fromArray = RegisterIO_SPI.LongArrayToU32Samples(new long[] { value }, valueBitWidth: 16, sampleBitWidth: 8, BitOrder.MsbFirst);
            uint[] fromSingle = RegisterIO_SPI.LongToU32Samples(value, valueBitWidth: 16, sampleBitWidth: 8, BitOrder.MsbFirst);
    ...
    public class U32SamplesToLongArrayTests
    {
        ...
        public void LsbFirst_TwoValues_8BitSample_ReturnsCorrectValues()
        {
            ...
            long[] result = RegisterIO_SPI.U32SamplesToLongArray(samples, sampleBitWidth: 8, valueCount: 2, BitOrder.LsbFirst);
        ...
        public void MsbFirst_TwoValues_16BitWidth_8BitSample_ReturnsCorrectValues()
        {
            ...
            long[] result = RegisterIO_SPI.U32SamplesToLongArray(samples, sampleBitWidth: 8, valueCount: 2, BitOrder.MsbFirst);
        ...
        {
            uint[] samples = RegisterIO_SPI.LongArrayToU32Samples(values, valueBitWidth, sampleBitWidth, BitOrder.LsbFirst);
            long[] roundTripped = RegisterIO_SPI.U32SamplesToLongArray(samples, sampleBitWidth, values.Length, BitOrder.LsbFirst);
        ...
        {
            uint[] samples = RegisterIO_SPI.LongArrayToU32Samples(values, valueBitWidth, sampleBitWidth, BitOrder.MsbFirst);
            long[] roundTripped = RegisterIO_SPI.U32SamplesToLongArray(samples, sampleBitWidth, values.Length, BitOrder.MsbFirst);
