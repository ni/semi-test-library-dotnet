...
namespace NationalInstruments.MixedSignalLibrary.InstrumentAbstraction.Digital
{
    ...
    public static class LevelsAndTiming
    {
        ...
        /// <summary>
        /// Configures a single level type. Use this method to configure the same level to all sessions.
        /// </summary>
        ...
        public static void ConfigureSingleLevelType(this DigitalSessionsBundle sessionsBundle, LevelType levelType, double levelValue)
        {
        ...
        /// <summary>
        /// Configures a single level type. Use this method to configure different levels for different sites.
        /// </summary>
        /// <param name="sessionsBundle">The <see cref="DigitalSessionsBundle"/> object.</param>
        /// <param name="levelType">The type of level to configure.</param>
        /// <param name="perSiteLevelValues">The per-site value of level to configure.</param>
        public static void ConfigureSingleLevelType(this DigitalSessionsBundle sessionsBundle, LevelType levelType, IDictionary<int, double> perSiteLevelValues)
        {
            sessionsBundle.Do((sessionInfo, sitePinInfo) =>
            {
                sessionInfo.Session.PinAndChannelMap.GetPinSet(sitePinInfo.SitePinString).ConfigureSingleLevel(levelType, perSiteLevelValues[sitePinInfo.SiteNumber.Value]);
            });
        }
        ...
        public static void ConfigureTimeSetCompareEdgesStrobe(this DigitalSessionsBundle sessionsBundle, string timeSet, IDictionary<int, double> compareEdges)
        {
            sessionsBundle.Do((sessionInfo, sitePinInfo) =>
            {
                sessionInfo.Session.Timing.GetTimeSet(timeSet).ConfigureCompareEdgesStrobe(sitePinInfo.SitePinString, Ivi.Driver.PrecisionTimeSpan.FromSeconds(compareEdges[sitePinInfo.SiteNumber.Value]));
            });
        }
        ...
        public static void ConfigureTimeSetCompareEdgesStrobe(this DigitalSessionsBundle sessionsBundle, string timeSet, IDictionary<int, Dictionary<string, double>> compareEdges)
        {
            sessionsBundle.Do((sessionInfo, sitePinInfo) =>
            {
                sessionInfo.Session.Timing.GetTimeSet(timeSet).ConfigureCompareEdgesStrobe(sitePinInfo.SitePinString, Ivi.Driver.PrecisionTimeSpan.FromSeconds(compareEdges[sitePinInfo.SiteNumber.Value][sitePinInfo.PinName]));
            });
        }
        ...
        public static void ConfigureTimeSetDriverEdges(
        ...
        public static void ApplyTDROffsets(this DigitalSessionsBundle sessionsBundle, IDictionary<int, Dictionary<string, double>> offsets)
        {
            sessionsBundle.Do((sessionInfo, sitePinInfo) =>
            {
                sessionInfo.Session.PinAndChannelMap.GetPinSet(sitePinInfo.SitePinString).ApplyTdrOffsets(new Ivi.Driver.PrecisionTimeSpan[] { Ivi.Driver.PrecisionTimeSpan.FromSeconds(offsets[sitePinInfo.SiteNumber.Value][sitePinInfo.PinName]) });
            });
        }
