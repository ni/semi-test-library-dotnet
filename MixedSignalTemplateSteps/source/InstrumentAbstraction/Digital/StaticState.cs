...
namespace NationalInstruments.MixedSignalLibrary.InstrumentAbstraction.Digital
{
    ...
    public static class StaticState
    {
        ...
        public static void WriteStatic(this DigitalSessionsBundle sessionsBundle, IDictionary<int, PinState> states)
        {
            ...
            {
                sessionInfo.Session.PinAndChannelMap.GetPinSet(sitePinInfo.SitePinString).WriteStatic(states[sitePinInfo.SiteNumber.Value]);
            });
        }
        ...
        public static void WriteStatic(this DigitalSessionsBundle sessionsBundle, IDictionary<int, Dictionary<string, PinState>> states)
        {
            sessionsBundle.Do((sessionInfo, sitePinInfo) =>
            {
                sessionInfo.Session.PinAndChannelMap.GetPinSet(sitePinInfo.SitePinString).WriteStatic(states[sitePinInfo.SiteNumber.Value][sitePinInfo.PinName]);
            });
        }
