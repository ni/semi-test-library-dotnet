...
namespace NationalInstruments.MixedSignalLibrary.InstrumentAbstraction.DMM
{
    ...
    public static class Acquisition
    {
        ...
        /// <returns>The measurment results in per-instrument format.</returns>
        public static double[] Fetch(this DMMSessionsBundle sessionsBundle, double maximumTimeInMilliseconds)
        {
        ...
        public static PinSiteData<double> FetchPerSitePerPinResults(this DMMSessionsBundle sessionsBundle, double maximumTimeInMilliseconds)
        {
        ...
        public static double[][] Fetch(this DMMSessionsBundle sessionsBundle, int numberToRead, double maximumTimeInMilliseconds)
        {
            return sessionsBundle.DoAndReturnPerInstrumentPerChannelResults(sessionInfo =>
            {
        ...
        /// <param name="maximumTimeInMilliseconds">The maximum time for the fetch to complete.</param>
        /// <returns>The measurment results in per-instrument format.</returns>
        public static double[] Read(this DMMSessionsBundle sessionsBundle, double maximumTimeInMilliseconds)
        {
            return sessionsBundle.DoAndReturnPerInstrumentPerChannelResults(sessionInfo =>
            {
        ...
        /// <param name="sessionsBundle">The <see cref="DMMSessionsBundle"/> object.</param>
        /// <param name="maximumTimeInMilliseconds">The maximum time for the fetch to complete.</param>
        /// <returns>The measurment results in per-site per-pin format.</returns>
        public static PinSiteData<double> ReadPerSitePerPinResults(this DMMSessionsBundle sessionsBundle, double maximumTimeInMilliseconds)
        {
            return sessionsBundle.DoAndReturnPerSitePerPinResults(sessionInfo =>
            {
        ...
        /// <param name="numberToRead">The number of values to fetch.</param>
        /// <param name="maximumTimeInMilliseconds">The maximum time for the fetch to complete.</param>
        /// <returns>The measurment results in per-instrument per-value format.</returns>
        public static double[][] Read(this DMMSessionsBundle sessionsBundle, int numberToRead, double maximumTimeInMilliseconds)
        {
            return sessionsBundle.DoAndReturnPerInstrumentPerChannelResults(sessionInfo =>
            {
