...
namespace NationalInstruments.Tests.TSMMixedSignalStepTemplates.Unit.DCPower
{
    ...
    public sealed class GetSetConfigurationTests : IDisposable
    {
        ...
        public void DifferentSMUDevices_SetMeasureWhen_CorrectValuesAreSet(bool pinMapWithChannelGroup)
        {
            ...
            var sessionsBundle = sessionManager.GetDCPowerSessionsBundle("VCC");
        ...
        public void DifferentSMUDevices_SetPowerLineFrequency_CorrectValuesAreSet(bool pinMapWithChannelGroup)
        {
            ...
            Assert.Equal(0, defaultValues.Values[0]["VCC"]);
            Assert.Equal(0, defaultValues.Values[1]["VCC"]);
            Assert.Equal(0, defaultValues.Values[2]["VCC"]);
            Assert.Equal(60, defaultValues.Values[3]["VCC"]);

            sessionsBundle.SetPowerLineFrequency(50);

            var setValues = sessionsBundle.GetPowerLineFrequencies();
            Assert.Equal(50, setValues.Values[0]["VCC"]);
            Assert.Equal(50, setValues.Values[1]["VCC"]);
            Assert.Equal(50, setValues.Values[2]["VCC"]);
            Assert.Equal(50, setValues.Values[3]["VCC"]);
        }
        ...
        {
            var sessionManager = Initialize(pinMapWithChannelGroup);
            var sessionsBundle = sessionManager.GetDCPowerSessionsBundle(new string[] { "VCC", "VDET" });
        ...
        public void DifferentSMUDevicesSetSameCurrentLimit_GetCurrentLimits_GetTheSameValue(bool pinMapWithChannelGroup)
        {
            ...
            Assert.Equal(0.1, values.Values[0]["VCC"]);
            Assert.Equal(0.1, values.Values[1]["VCC"]);
            Assert.Equal(0.1, values.Values[2]["VCC"]);
            Assert.Equal(0.1, values.Values[3]["VCC"]);
        }
        ...
        public void DifferentSMUDevicesSetPerPinCurrentLimit_GetCurrentLimits_GetPerDeviceValues(bool pinMapWithChannelGroup)
        {
            ...
            Assert.Equal(1, values.Values[0]["VCC"]);
            Assert.Equal(0.1, values.Values[1]["VDD"]);
            Assert.Equal(0.01, values.Values[2]["VDET"]);
        }
        ...
        public void DifferentSMUDevices_GetApertureTimes_CorrectValuesAreGet(bool pinMapWithChannelGroup)
        {
            ...
            Assert.Equal(0.0033, apertureTimes.Values[0]["VCC"], 4);
            Assert.Equal(0.0033, apertureTimes.Values[1]["VCC"], 4);
            Assert.Equal(0.0017, apertureTimes.Values[2]["VCC"], 4);
            Assert.Equal(0.017, apertureTimes.Values[3]["VCC"], 3);
        ...
        public void DifferentSMUDevices_ConfigureSameMeasureSettings_CorrectValuesAreSet(bool pinMapWithChannelGroup)
        {
            ...
            Assert.Equal(0.1, apertureTimes.Values[0]["VCC"]);
            Assert.Equal(0.1, apertureTimes.Values[1]["VCC"]);
            Assert.Equal(0.1, apertureTimes.Values[2]["VCC"]);
            Assert.Equal(0.1, apertureTimes.Values[3]["VCC"]);
        }
