...
namespace NationalInstruments.Tests.TSMMixedSignalStepTemplates.Unit.Digital
{
    ...
    public class LevelsAndTimingTests
    {
        ...
        public void SessionsInitialized_ConfigureTheSameLevel_ValueCorrectlySet(string pinMap, string digitalProject)
        {
            ...
            sessionsBundle.ConfigureSingleLevelType(LevelsAndTiming.LevelType.Vih, levelValue: 3.5);
        ...
        public void TwoDevicesWorkForTwoSitesSeparately_ConfigurePerSiteLevels_ValueCorrectlySet()
        {
            ...
            sessionsBundle.ConfigureSingleLevelType(LevelsAndTiming.LevelType.Vil, levels);
        ...
        public void SessionsInitialized_ConfigureTimeSetDriverEdges_ValueCorrectlySet(string pinMap, string digitalProject)
        {
            ...
            var sessionsBundle = sessionManager.GetDigitalSessionsBundle(new string[] { "C0", "C1" });
            sessionsBundle.ConfigureTimeSetDriverEdges("TS_SW", DriveFormat.ReturnToHigh, driveOn: 5e-6, driveData: 5e-6, driveReturn: 1e-5, driveOff: 1e-5);
        ...
        public void SessionsInitialized_ConfigureTimeSetDriverEdgesWithTwoDriveData_ValueCorrectlySet(string pinMap, string digitalProject)
        {
            ...
            var sessionsBundle = sessionManager.GetDigitalSessionsBundle(new string[] { "C0", "C1" });
            sessionsBundle.ConfigureTimeSetDriverEdges("TS_SW", DriveFormat.ReturnToLow, driveOn: 5e-6, driveData: 5e-6, driveReturn: 1e-5, driveOff: 2e-5, driveData2: 1.5e-5, driveReturn2: 2e-5);
