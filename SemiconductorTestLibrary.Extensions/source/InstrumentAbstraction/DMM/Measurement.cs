...
namespace NationalInstruments.SemiconductorTestLibrary.InstrumentAbstraction.DMM
{
    ...
    public static class Measurement
    {
        ...
        /// <param name="maximumTimeInMilliseconds">The maximum time for the fetch to complete in milliseconds.</param>
        /// <returns>The measurement results in per-site per-pin format.</returns>
        public static PinSiteData<double[]> Fetch(this DMMSessionsBundle sessionsBundle, int samplesToFetch, double maximumTimeInMilliseconds)
        {
            return sessionsBundle.DoAndReturnPerSitePerPinResults(sessionInfo =>
            {
        ...
        [Obsolete("This method is obsolete, use the Fetch(int numberOfPoints, double maximumTimeInMilliseconds) method instead.")]
        public static double[][] FetchMultiPoint(this DMMSessionsBundle sessionsBundle, int numberOfPoints, double maximumTimeInMilliseconds)
        {
            return sessionsBundle.DoAndReturnPerInstrumentPerChannelResults(sessionInfo =>
            {
                return sessionInfo.Session.Measurement.FetchMultiPoint(PrecisionTimeSpan.FromMilliseconds(maximumTimeInMilliseconds), numberOfPoints);
            });
        }
        ...
        /// <param name="maximumTimeInMilliseconds">The maximum time for the fetch to complete in milliseconds.</param>
        /// <returns>The measurement results in per-site per-pin format.</returns>
        public static PinSiteData<double[]> Read(this DMMSessionsBundle sessionsBundle, int numberOfPoints, double maximumTimeInMilliseconds)
        {
            return sessionsBundle.DoAndReturnPerSitePerPinResults(sessionInfo =>
            {
        ...
        [Obsolete("This method is obsolete, use the Read(int numberOfPoints, double maximumTimeInMilliseconds) method instead.")]
