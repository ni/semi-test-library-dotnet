...
namespace NationalInstruments.SemiconductorTestLibrary.InstrumentAbstraction.DCPower
{
    ...
    public static class Measure
    {
        ...
        public static Tuple<double[][], double[][]> MeasureAndReturnPerInstrumentPerChannelResults(this DCPowerSessionsBundle sessionsBundle)
        {
            ...
            sessionsBundle.TriggerChannelsWaitingOnMeasureTrigger();
        ...
        private static void TriggerChannelsWaitingOnMeasureTrigger(this DCPowerSessionsBundle sessionsBundle)
        {
