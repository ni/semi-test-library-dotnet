...
namespace NationalInstruments.SemiconductorTestLibrary.InstrumentAbstraction.DCPower
{
    ...
    public static class Measure
    {
        ...
        {
            sessionsBundle.ClearBacklogAndSendSoftwareEdgeTrigger();
        ...
        private static void ClearBacklogAndSendSoftwareEdgeTrigger(this DCPowerSessionsBundle sessionsBundle)
        {
            sessionsBundle.Do((sessionInfo, sitePinInfo) =>
            {
