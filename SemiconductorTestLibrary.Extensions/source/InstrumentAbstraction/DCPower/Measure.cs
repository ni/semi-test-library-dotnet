...
namespace NationalInstruments.SemiconductorTestLibrary.InstrumentAbstraction.DCPower
{
    ...
    public static class Measure
    {
        ...
        {
            return sessionsBundle.DoAndReturnPerSitePerPinResults(sessionInfo => sessionInfo.MeasureVoltageAndCurrent(), caseDescription: string.Empty, CascadeCurrentOrVoltageMeasurement.VoltageMeasurement, CascadeCurrentOrVoltageMeasurement.CurrentMeasurement);
        }
        ...
        {
            return sessionsBundle.DoAndReturnPerSitePerPinResults(sessionInfo => sessionInfo.MeasureVoltageAndCurrent().Item1, caseDescription: string.Empty, CascadeCurrentOrVoltageMeasurement.VoltageMeasurement);
        }
        ...
        {
            return sessionsBundle.DoAndReturnPerSitePerPinResults(sessionInfo => sessionInfo.MeasureVoltageAndCurrent().Item2, caseDescription: string.Empty, CascadeCurrentOrVoltageMeasurement.CurrentMeasurement);
        }
