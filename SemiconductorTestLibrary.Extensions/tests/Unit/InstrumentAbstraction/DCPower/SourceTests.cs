...
namespace NationalInstruments.Tests.SemiconductorTestLibrary.Unit.InstrumentAbstraction.DCPower
{
    ...
    public sealed class SourceTests : IDisposable
    {
        ...
        [Fact]
        public void DifferentSMUDevicesGanged_ForcePerPinCurrentsWithSymmetricLimitOnGroup_CorrectCurrentsForced()
        {
            var sessionManager = Initialize("SMUGangPinGroup_SessionPerChannel.pinmap");
            var sessionsBundle = sessionManager.DCPower(AllPinsGangedGroup);
            sessionsBundle.GangPinGroup(ThreePinsGangedGroup);
        ...
        public void DifferentSMUDevicesGanged_ForcePerPinPerSiteCurrentsWithSymmetricLimit_CorrectCurrentsForced()
        {
            ...
            sessionsBundle.Do((sessionInfo, sitePinInfo) =>
            {
                ...
                {
                    AssertCurrentSettings(channelOutput, expectedCurrentLevel: 0.6, expectedVoltageLimit: 4.5);
                }
                AssertTriggerSettings(sitePinInfo, channelOutput, sitePinInfo.SiteNumber == 0 ? "SMU_4137_C5_S02/0" : "SMU_4137_C5_S03/0");
            });
        }
        ...
        [Fact]
        public void DifferentSMUDevicesGanged_ForceVoltageWithPerPinSettingsObjectOnGroup_SameVoltageForcedAndCurrentLimitDividedEqually()
        {
            var sessionManager = Initialize("SMUGangPinGroup_SessionPerChannel.pinmap");
            var sessionsBundle = sessionManager.DCPower(AllPinsGangedGroup);
            sessionsBundle.GangPinGroup(ThreePinsGangedGroup);
        ...
        public void DifferentSMUDevicesGanged_ForceCurrentWithPerSiteSettingsObject_CorrectCurrentsForced()
        {
            ...
            sessionsBundle.Do((sessionInfo, sitePinInfo) =>
            {
                ...
                {
                    AssertCurrentSettings(channelOutput, expectedCurrentLevel: 0.5, expectedVoltageLimit: 5);
                }
                AssertTriggerSettings(sitePinInfo, channelOutput, sitePinInfo.SiteNumber == 0 ? "SMU_4137_C5_S02/0" : "SMU_4137_C5_S03/0");
            });
        }
        ...
        [Fact]
        public void DifferentSMUDevicesGanged_ForceCurrentWithPerPinSettingsObjectOnGroup_CorrectCurrentsForced()
        {
            var sessionManager = Initialize("SMUGangPinGroup_SessionPerChannel.pinmap");
            var sessionsBundle = sessionManager.DCPower(AllPinsGangedGroup);
            sessionsBundle.GangPinGroup(ThreePinsGangedGroup);
        ...
        [Fact]
        public void DifferentSMUDevicesGanged_ForceCurrentWithPerPinPerSiteSettingsObjectWithGroup_CorrectCurrentsForced()
        {
            var sessionManager = Initialize("SMUGangPinGroup_SessionPerChannel.pinmap");
            var sessionsBundle = sessionManager.DCPower(AllPinsGangedGroup);
            sessionsBundle.GangPinGroup(FourPinsGangedGroup);
            ...
            sessionsBundle.Do((sessionInfo, sitePinInfo) =>
            {
                ...
                if (sitePinInfo.CascadingInfo is GangingInfo)
                {
                    AssertCurrentSettings(channelOutput, expectedCurrentLevel: 0.25, expectedVoltageLimit: 6);
                }
                else
                {
                    AssertCurrentSettings(channelOutput, expectedCurrentLevel: 1.0, expectedVoltageLimit: 6);
                }
                AssertTriggerSettings(sitePinInfo, channelOutput, sitePinInfo.SiteNumber == 0 ? "SMU_4137_C5_S02/0" : "SMU_4137_C5_S03/0");
            });
        }
        ...
        public void DifferentSMUDevicesGanged_ConfigureCurrentSourceSettingsWithSiteData_CorrectValuesAreSetAndCurrentLevelDivided()
        {
            ...
            sessionsBundle.Do((sessionInfo, sitePinInfo) =>
            {
                var channelOutput = sessionInfo.Session.Outputs[sitePinInfo.IndividualChannelString];
                Assert.Equal(DCPowerSourceOutputFunction.DCCurrent, channelOutput.Source.Output.Function);
                AssertCurrentSettings(channelOutput, expectedCurrentLevel: sitePinInfo.SiteNumber == 0 ? 0.5 : 1.0, expectedVoltageLimit: sitePinInfo.SiteNumber == 0 ? 7 : 5);
                AssertTriggerSettings(sitePinInfo, channelOutput, sitePinInfo.SiteNumber == 0 ? "SMU_4137_C5_S02/0" : "SMU_4137_C5_S03/0");
            });
        }

        [Fact]
        public void DifferentSMUDevicesGanged_ConfigureCurrentSourceSettingsWithPinSiteDataOnGroup_CorrectValuesAreSetAndCurrentLevelDivided()
        {
            var sessionManager = Initialize("SMUGangPinGroup_SessionPerChannel.pinmap");
            var sessionsBundle = sessionManager.DCPower("AllPinsGangedGroup");
            sessionsBundle.GangPinGroup(FourPinsGangedGroup);
        ...
        [Fact]
        public void DifferentSMUDevicesGanged_ConfigurePerPinCurrentSourceSettingsOnGroup_CorrectValuesAreSetAndCurrentLevelDivided()
        {
            var sessionManager = Initialize("SMUGangPinGroup_SessionPerChannel.pinmap");
            var sessionsBundle = sessionManager.DCPower("AllPinsGangedGroup");
            sessionsBundle.GangPinGroup(ThreePinsGangedGroup);
        ...
        public void DifferentSMUDevicesGanged_ConfigureVoltageSourceSettingsWithSiteData_CorrectValuesAreSetAndCurrentLimitDivided()
        {
            ...
            sessionsBundle.Do((sessionInfo, sitePinInfo) =>
            {
                var channelOutput = sessionInfo.Session.Outputs[sitePinInfo.IndividualChannelString];
                Assert.Equal(DCPowerSourceOutputFunction.DCVoltage, channelOutput.Source.Output.Function);
                AssertVoltageSettings(sitePinInfo, channelOutput, 4, 1, 1);
                AssertTriggerSettings(sitePinInfo, channelOutput, sitePinInfo.SiteNumber == 0 ? "SMU_4137_C5_S02/0" : "SMU_4137_C5_S03/0");
            });
        }
        ...
        [Fact]
        public void DifferentSMUDevicesGanged_ConfigureVoltageSourceSettingsWithPinSiteDataOnGroup_CorrectValuesAreSetAndCurrentLimitDivided()
        {
            var sessionManager = Initialize("SMUGangPinGroup_SessionPerChannel.pinmap");
            var sessionsBundle = sessionManager.DCPower("AllPinsGangedGroup");
            sessionsBundle.GangPinGroup(ThreePinsGangedGroup);
        ...
        [Fact]
        public void DifferentSMUDevicesGanged_ConfigurePerPinVoltageSourceSettingsOnGroup_CorrectValuesAreSetAndCurrentLimitDivided()
        {
            var sessionManager = Initialize("SMUGangPinGroup_SessionPerChannel.pinmap");
            var sessionsBundle = sessionManager.DCPower("AllPinsGangedGroup");
            sessionsBundle.GangPinGroup(AllPinsGangedGroup);
